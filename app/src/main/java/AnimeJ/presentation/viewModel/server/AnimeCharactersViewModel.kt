...
import AnimeJ.presentation.state.server.AnimeCharactersUiState
...
@HiltViewModel
class AnimeCharactersViewModel @Inject constructor(val repository: AnimeRepository): ViewModel(){
